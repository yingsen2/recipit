		...
		<div id="topbar-inner">
			<div class="container"> 
				<div class="row"; style="float:right" >
					<div class="dropdown" >
						<ul id="nav" class="nav">
							<li class="menu-item"><a class="smoothScroll" href="#about" title="About Me"><i class="icon-user"></i></a></li>
							<li class="menu-item"><a class="smoothScroll" href="#resume" title="Resume"><i class="icon-file"></i></a></li>
							<li class="menu-item"><a class="smoothScroll" href="#Myblog" title="My Blog"><i class="icon-book"></i></a></li>
							<li class="menu-item"><a class="smoothScroll" href="#contact" title="Contact"><i class="icon-phone"></i></a></li>
						</ul><!--/ uL#nav -->
					</div><!-- /.dropdown -->
...
<img src=".//yingsen/Public/assets/img/header-bg.jpg" alt="background" class="img-responsive right-block"> -->
	...
	<div id="intro">
		<div class="container">
			<div class="row">
				...
				<ul>
					<li>在读大三本科生，研究信息信号处理、图像编码与处理</li>
                    <li>业余摄影师，擅长风光摄影和人物摄影，欢迎找我约拍。</li>
                    <li>设计爱好者，熟练掌握Photoshop和lightroom。</li>
				</ul>
	...
	<div class="container desc">
		<div class="row">
				...
				<div class="col-lg-6">
					<p>
					<ul class="list-inline"><t>北京邮电大学</t>
					<li></li>
						<li>信息与通信工程学院</li>
						<li>信息工程</li>
						<li>本科</li>
					</ul>
					<ul class="list-inline"><t>主修课程：</t>
					<li>通信原理</li>
					<li>DSP</li>
					<li>信号与系统</li>
					<li>数据结构</li>
					...
					<ul class="list-inline"><t>获得两次优秀奖学金</t></ul>
					<ul class="list-inline"><t>获得校三好学生</t></ul>
					<t>获得优秀团干部</t>		 	
					</p>
				</div>
				<div class="col-lg-3">
				<br/>
					<imp><sm>2013.9--now</imp>
	...
	<div class="container desc">
		<div class="row">
				...
				<br/>
					<ul><t>信通院学生会</t><br/>
						<j>宣传部干事</j><br/> 
					<li><more> 负责宣传品的制作：海报、彩喷、入场券、工作证……</li></more>
					<li><more>熟悉photoshop和iilustrator</li></more></ul>
				</div>
				<div class="col-lg-3">
				<br/>
					<imp><sm>2013.9--2015.6</imp>
	...
	<br/>
					<ul><t>大学生英语课程</t><br/>
						<j>助教</j><br/> 
					<li><more> 负责收发作业</li></more>
					<li><more>举办活动</li></more></ul>
				</div>
							<div class="col-lg-3">
				<br/>
					<imp><sm>2013.9--2014.6</imp>
	...
	<br/>
					<ul><t>信通院四大班</t><br/>
						<j>宣传委员</j><br/> 
					<li><more> 学院活动记录</li></more>
					<li><more>学院活动宣传</li></more></ul>
				</div>
							<div class="col-lg-3">
				<br/>
					<imp><sm>2015.9--2016.6</imp>
	...
	<div class="container desc">
		<div class="row">
				...
				<br/>
					<ul><t>智能聊天机器人</t><br/>
						<j>组长</j><br/> 
					<li><more> 聊天UI的设计和编程。</li></more>
					<li><more>编写相应的网络接口</li></more></ul>
				</div>
				<div class="col-lg-3">
				<br/>
				 ...
				 <div class="col-lg-6 col-lg-offset-3">
	<br/>
					<ul><t>基于新浪云的微信远程控制插排</t><br/>
						<j>组长</j><br/> 
					<li><more> 新浪云服务器的搭建</li></more>
					<li><more>微信接口的连接</more></li>
				</div>
							<div class="col-lg-3">
				<br/>
				 ...
				 <div class="col-lg-6 col-lg-offset-3">
	<br/>
					<ul><t>基于51单片机的避障走迷宫小车</t><br/>
						<j>组长</j><br/> 
					<li><more> 电路的焊接</li></more>
					<li><more> 算法的设计和编写</more></li>
				</div>
							<div class="col-lg-3">
				<br/>
		...
		<div class="container">
			<div class="row">
					<div class="col-lg-11 col-lg-offset-1">
						<h3 style="color:#ffffff">My Photograph</h3>
					</div>
...
<div class="col-lg-10 col-lg-offset-1 centered">
 ...
 -->
	...
	<section id="Myblog" name="Myblog"></section>
	...
	<div class="container desc">
		<div class="row">
				...
				<div class="col-lg-6 col-lg-offset-3 panel-group " id="accordion">
					...
					<div id="collapseOne" class="panel-collapse collapse ">
						<div class="panel-body">
							<h3>简历要有针对性</h3>
                    <j>1、还原真实自己<br/>
     要针对自己，写出自己在大学或者是原来工作时的亮点。大学时的可以写获得过奖学金、xx竞赛奖励、到过什么单位实习、
     组织了什么活动并且取得哪些成绩等，诸如此类的亮点，找到自己最与众不同而且可以反映自己良好素质的一面。<br/>
     2、针对企业，有备而去       <br/>
要针对你想要应聘的企业和其职位。当你写完自己的亮点后，就应该根据自己所应聘的职位或者企业来对简历进行一定程度的筛
选和修改了。比如你应聘的是技术型工作，那么就要把重点放在你的专业成绩、实践能力和团队精神上面；如果是应聘销售类工
作，重点则在于你的沟通能力、人际交往能力和自己不服输的精神上。
                    </j>
                    <h3>简历要言而有物</h3>
                    <j>简历的内容一定要具体，切忌虚假和空洞。经常会在简历上面看到“有较强的沟通能力、很强的社会实
                    践能力、抗压性高……”、“我援用我的热情开为贵企业奉献全部的力量！”虽说这些话听起来是豪情万丈的，
                    但对HR来说去是一点用都没有。并不是说这些不可以写，但是你每写一条的时候都应该要拿出事实和自己
                    的经历来作为佐证，不可能你说什么，HR就相信什么嘛。HR面试你，就是要通过你的一言一行和你过往的
                    经历来判断你的素质和能力是否可以符合公司的标准。</j>
					<h3>赢在细节</h3>
					<j>简历的细节不容忽视。邮件简历的排版错乱、字体杂乱、错别字等问题让HR很头疼，写得再好的简历在
					这个关键时刻出错就一切都白费了。<br/>
曾经有一份简历给我留下很深刻的印象，简历制作得很漂亮，简历内容写得很好很详细，排版也非常的工整，而且还在简历的背后
附带有一份职业测评报告，让我觉得这个应聘者很细心。我记得面试的时候问过她，她告诉我说这种是网页版简历，和其他的简历
不一样，不用附件形式就可以发送出去了，而且排版也不会错乱。最让我窝心的是她还说到，自己的姐姐也是做HR的，知道很多企
业现在都会要求应聘者进行职业测评，所以为了减轻HR的辛苦，她就自己先到朗识测评网站去做了一个职业特质测评。</j>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-6 col-lg-offset-3 panel-group " id="accordion">
					...
					<div id="collapseThree" class="panel-collapse collapse ">
						<div class="panel-body">
							<j>本来以为制作网页是一件很难的东西，其实只要掌握了要点，并且学会查看帮助文件，一步一步探索，就能够完成。
							本网页是基于BlackTie的模板，但是为了个性化，添加了许多JS的插件，例如，图片的轮播和博客的折叠。加入一些有
							动态特效的东西，能够使网页看起来更加酷炫。本网页是静态网页，没有后台管理。这只是初步，如果时间足够，我会将
							此网页当做我的个人主页，并且加入后台，不断完善这个网页。感谢这个小学期的课程，让我踏出了制作网页的第一步。</j>
						</div>
					</div>
				</div>
...
<br/>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3">
					<p><t>Address</t><br/>
					Building 2,<br/>
					Beijing University of Posts and Telecommunication,<br/>
					No.10 Xitucheng Road,100786<br/>
					China</p>
					<!-- <p>
	...
	<div id="c">
		...
		<li><t>Created by</t></li>
		<li style="color:#1abc9c"><t>Wilson_Tsang</t></li>
		<li><t>at 16/7/7</t></li>		
		</ul>
		<ul class="list-inline" style="color:#ffffff">
			<li  ><t>Supproted by</t></li>
			<li style="color:#1abc9c"><t>BlackTie</t></li>
		</ul>
		</div>
